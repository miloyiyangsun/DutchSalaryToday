  ...
  return (
    <div className="container">
      ...
      <section style={{ marginTop: "2rem" }}>
        ...
        >
          ...
          >
            ...
            <p>
              Female workforce percentage increased by{" "}
              <strong>7.1 points</strong> over 30 years
            </p>
          </div>
          ...
          >
            ...
            <p>
              Women secured <strong>60.1%</strong> of all new positions created
              2010-2024
            </p>
          </div>
          ...
          >
            ...
            <p>
              <strong>17 industries</strong> now have female majority workforce
            </p>
          </div>
        </div>
      </section>
      ...
      <footer style={{ marginTop: "3rem" }}>
        <p>
          Story 3 Data Source: CBS Netherlands Statistics | Gender Employment
          Analysis
        </p>
      </footer>
    </div>
