      ...
      >
        ...
        <div style={{ marginTop: "1.5rem", marginBottom: "1.5rem" }}>
          ...
          >
            ...
            <li>
              💸 Industry Gap: 6.6x disparity between highest and lowest sectors
            </li>
      ...
      <section style={{ marginTop: "2rem" }}>
        ...
        >
          ...
          >
            ...
            <p>
              Netherlands employers pay <strong>€22.8</strong> in social
              contributions for every €100 in total compensation (2024)
            </p>
          </div>
          ...
          >
            ...
            <p>
              Benefit burden varies: <strong>6.6x difference</strong> between
              highest (30.3%) and lowest (4.6%) industries
            </p>
          </div>
          ...
          >
            ...
            <p>
              <strong>+85.8% increase</strong> in total social contributions
              (€256B → €476B, 2010-2024)
            </p>
          </div>
        </div>
